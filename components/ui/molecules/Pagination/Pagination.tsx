import useFetchNextPage from '@/hook/useFetchNextPage';
...
const Pagination: FC<Props> = ({ hasNextPage, fetchNextPage, handleNextPage, currentPage, handlePreviousPage }) => {
            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                    <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        <button onClick={(e)=>handlePreviousPage(currentPage)} className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                        ...
                        <button onClick={(e) => handleNext(e, hasNextPage, fetchNextPage)} className="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
